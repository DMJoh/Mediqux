    ...
    await queryInterface.bulkInsert('medications', [
      {
        ...
        active_ingredients: JSON.stringify([{ name: 'Metformin Hydrochloride', dosage: '500mg' }]),
      ...
      },
      {
        ...
        dosage_forms: ['Tablet'],
        strengths: ['5mg', '10mg'],
        active_ingredients: JSON.stringify([{ name: 'Amlodipine Besylate', dosage: '5mg' }]),
        manufacturer: 'Generic',
      ...
      },
      {
        ...
        active_ingredients: JSON.stringify([{ name: 'Levothyroxine Sodium', dosage: '50mcg' }]),
        manufacturer: 'Generic',
      ...
      },
      {
        ...
        active_ingredients: JSON.stringify([{ name: 'Atorvastatin Calcium', dosage: '20mg' }]),
        manufacturer: 'Generic',
